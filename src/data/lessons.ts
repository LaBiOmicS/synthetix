...
export const lessons: Lesson[] = [
  ...
  // --- NÍVEL 3: O DOMÍNIO DA REPETIÇÃO ---
  {
    id: 'lvl3-e1-c1',
  ...
  // --- NÍVEL 4: O ARQUITETO DE FUNÇÕES ---
  {
    id: 'lvl4-e1-c1',
  ...
  // --- NÍVEL 5: O ARSENAL DO ENGENHEIRO ---
  {
    id: 'lvl5-e1-c1',
  ...
  // --- NÍVEL 6: O MODELO DO MUNDO (POO BÁSICO) ---
  {
    id: 'lvl6-e1-c1',
