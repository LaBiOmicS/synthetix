    ...
    <aside className={cn(
      ...
      <div className="p-5 border-b border-slate-800 min-w-[280px]">
        ...
        <div className="bg-slate-800/50 rounded-2xl p-3.5 border border-slate-700/50">
          <div className="flex justify-between items-end mb-2">
            ...
            <span className="text-[10px] text-slate-400 font-medium">{xp} XP Total</span>
          </div>
      ...
      <div className="p-3 border-t border-slate-800/50 min-w-[280px]">
        <button 
          ...
          className="w-full py-2 rounded-lg text-[9px] text-slate-600 hover:text-red-400 hover:bg-red-400/5 uppercase tracking-widest font-bold transition-all"
        >
          Resetar Progresso
        </button>
      </div>
